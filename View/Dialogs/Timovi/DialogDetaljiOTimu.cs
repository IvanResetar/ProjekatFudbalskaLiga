...
namespace View.Dialogs.Timovi
{
    public partial class DialogDetaljiOTimu : Form
    {
        ...
        private void btnUtakmiceTima_Click(object sender, EventArgs e)
        {
            kontrolerTimovi.OtvoriDialogUtakmiceTima(tim);
        }

        private void btnNapadaciTima_Click(object sender, EventArgs e)
        {
            kontrolerTimovi.OtvoriDialogNapadaciTima(tim);
        }
    }
}
